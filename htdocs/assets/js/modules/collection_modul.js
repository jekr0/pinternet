class CollectionModalComponent {
  ...
  async open(){ this.setModalUrl('/collections-editing'); this.resetForm(); this.showOnly(); await this.load(); this.renderTags(); this.setCreateMode(true); this.nameInput?.focus(); }
